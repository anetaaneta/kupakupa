...
public:
    ...
    QLabel *label_10;
    QFrame *frame;
    QComboBox *user_bw_up_unit;
    QComboBox *user_bw_down_unit;
    QSpinBox *user_bw_up;
    QLabel *label_5;
    QSpinBox *user_bw_down;
    QLabel *label_6;
    QLabel *label_7;
    QFrame *frame_6;
    QLabel *label_27;
    QLabel *label_21;
    QDoubleSpinBox *delay_pdv;
    QDoubleSpinBox *avg_delay;
    QLabel *label_22;
    QLabel *label_26;
    QDoubleSpinBox *k;
    QComboBox *error_model_2;
    QDoubleSpinBox *error_rate_2;
    QLabel *label_2;
    QLabel *label_3;
    QFrame *frame_7;
    QLabel *label_38;
    QLabel *label_39;
    QDoubleSpinBox *delay_pdv_up;
    QDoubleSpinBox *avg_delay_up;
    QLabel *label_40;
    QLabel *label_41;
    QDoubleSpinBox *k_up;
    ...
    void setupUi(QMainWindow *kupagui)
    {
        ...
        groupBox->setGeometry(QRect(10, 0, 601, 481));
        ...
        label_24->setGeometry(QRect(20, 80, 71, 20));
        ...
        label_15->setGeometry(QRect(20, 50, 81, 20));
        ...
        label_31->setGeometry(QRect(20, 80, 70, 20));
        ...
        label_29->setGeometry(QRect(20, 20, 70, 16));
        label_30 = new QLabel(servermemory);
        label_30->setObjectName(QStringLiteral("label_30"));
        label_30->setGeometry(QRect(20, 50, 80, 20));
        ...
        label_25->setGeometry(QRect(20, 80, 71, 20));
        tcp_mem_user_rmem_wget = new QLineEdit(usermemory_2);
        tcp_mem_user_rmem_wget->setObjectName(QStringLiteral("tcp_mem_user_rmem_wget"));
        tcp_mem_user_rmem_wget->setGeometry(QRect(110, 80, 201, 20));
        tcp_mem_user_rmem_wget->setMaxLength(200);
        label_16 = new QLabel(usermemory_2);
        label_16->setObjectName(QStringLiteral("label_16"));
        label_16->setGeometry(QRect(20, 50, 81, 20));
        tcp_mem_user_wget = new QLineEdit(usermemory_2);
        tcp_mem_user_wget->setObjectName(QStringLiteral("tcp_mem_user_wget"));
        tcp_mem_user_wget->setGeometry(QRect(110, 20, 201, 20));
        tcp_mem_user_wget->setMaxLength(200);
        label_11 = new QLabel(usermemory_2);
        label_11->setObjectName(QStringLiteral("label_11"));
        label_11->setGeometry(QRect(20, 20, 71, 16));
        tcp_mem_user_wmem_wget = new QLineEdit(usermemory_2);
        tcp_mem_user_wmem_wget->setObjectName(QStringLiteral("tcp_mem_user_wmem_wget"));
        tcp_mem_user_wmem_wget->setGeometry(QRect(110, 50, 201, 20));
        ...
        error_model->setGeometry(QRect(400, 270, 69, 22));
        error_rate = new QDoubleSpinBox(groupBox);
        error_rate->setObjectName(QStringLiteral("error_rate"));
        error_rate->setGeometry(QRect(400, 300, 71, 22));
        error_rate->setDecimals(3);
        error_rate->setSingleStep(0.001);
        error_rate->setValue(0);
        label_9 = new QLabel(groupBox);
        label_9->setObjectName(QStringLiteral("label_9"));
        label_9->setGeometry(QRect(260, 270, 141, 16));
        label_10 = new QLabel(groupBox);
        label_10->setObjectName(QStringLiteral("label_10"));
        label_10->setGeometry(QRect(260, 300, 131, 16));
        frame = new QFrame(groupBox);
        frame->setObjectName(QStringLiteral("frame"));
        frame->setGeometry(QRect(10, 260, 241, 91));
        frame->setFrameShape(QFrame::StyledPanel);
        frame->setFrameShadow(QFrame::Raised);
        user_bw_up_unit = new QComboBox(frame);
        user_bw_up_unit->setObjectName(QStringLiteral("user_bw_up_unit"));
        user_bw_up_unit->setGeometry(QRect(160, 60, 64, 22));
        user_bw_down_unit = new QComboBox(frame);
        user_bw_down_unit->setObjectName(QStringLiteral("user_bw_down_unit"));
        user_bw_down_unit->setGeometry(QRect(160, 30, 65, 22));
        user_bw_up = new QSpinBox(frame);
        user_bw_up->setObjectName(QStringLiteral("user_bw_up"));
        user_bw_up->setGeometry(QRect(71, 60, 81, 22));
        user_bw_up->setValue(10);
        label_5 = new QLabel(frame);
        label_5->setObjectName(QStringLiteral("label_5"));
        label_5->setGeometry(QRect(10, 30, 41, 16));
        user_bw_down = new QSpinBox(frame);
        user_bw_down->setObjectName(QStringLiteral("user_bw_down"));
        user_bw_down->setGeometry(QRect(71, 30, 81, 22));
        user_bw_down->setMaximum(999);
        user_bw_down->setValue(1);
        label_6 = new QLabel(frame);
        label_6->setObjectName(QStringLiteral("label_6"));
        label_6->setGeometry(QRect(10, 60, 61, 16));
        ...
        avg_delay->setGeometry(QRect(150, 60, 69, 27));
        avg_delay->setDecimals(3);
        avg_delay->setMaximum(999);
        avg_delay->setSingleStep(0.5);
        ...
        k->setGeometry(QRect(150, 30, 69, 27));
        k->setDecimals(3);
        k->setMaximum(5);
        k->setSingleStep(0.1);
        k->setValue(0.1);
        error_model_2 = new QComboBox(groupBox);
        error_model_2->setObjectName(QStringLiteral("error_model_2"));
        error_model_2->setGeometry(QRect(520, 270, 69, 22));
        error_rate_2 = new QDoubleSpinBox(groupBox);
        error_rate_2->setObjectName(QStringLiteral("error_rate_2"));
        error_rate_2->setGeometry(QRect(520, 300, 71, 22));
        error_rate_2->setDecimals(3);
        error_rate_2->setSingleStep(0.001);
        error_rate_2->setValue(0);
        label_2 = new QLabel(groupBox);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(480, 270, 31, 17));
        label_3 = new QLabel(groupBox);
        label_3->setObjectName(QStringLiteral("label_3"));
        label_3->setGeometry(QRect(480, 300, 31, 20));
        frame_7 = new QFrame(groupBox);
        frame_7->setObjectName(QStringLiteral("frame_7"));
        frame_7->setGeometry(QRect(260, 350, 241, 121));
        frame_7->setFrameShape(QFrame::StyledPanel);
        frame_7->setFrameShadow(QFrame::Raised);
        label_38 = new QLabel(frame_7);
        label_38->setObjectName(QStringLiteral("label_38"));
        label_38->setGeometry(QRect(10, 10, 131, 16));
        label_38->setFont(font);
        label_39 = new QLabel(frame_7);
        label_39->setObjectName(QStringLiteral("label_39"));
        label_39->setGeometry(QRect(10, 90, 121, 17));
        delay_pdv_up = new QDoubleSpinBox(frame_7);
        delay_pdv_up->setObjectName(QStringLiteral("delay_pdv_up"));
        delay_pdv_up->setGeometry(QRect(150, 90, 69, 27));
        delay_pdv_up->setDecimals(3);
        delay_pdv_up->setMaximum(999);
        delay_pdv_up->setSingleStep(0.1);
        delay_pdv_up->setValue(0);
        avg_delay_up = new QDoubleSpinBox(frame_7);
        avg_delay_up->setObjectName(QStringLiteral("avg_delay_up"));
        avg_delay_up->setGeometry(QRect(150, 60, 69, 27));
        avg_delay_up->setDecimals(3);
        avg_delay_up->setMaximum(999);
        avg_delay_up->setSingleStep(0.5);
        avg_delay_up->setValue(1);
        label_40 = new QLabel(frame_7);
        label_40->setObjectName(QStringLiteral("label_40"));
        label_40->setGeometry(QRect(10, 60, 121, 21));
        label_41 = new QLabel(frame_7);
        label_41->setObjectName(QStringLiteral("label_41"));
        label_41->setGeometry(QRect(10, 40, 101, 21));
        k_up = new QDoubleSpinBox(frame_7);
        k_up->setObjectName(QStringLiteral("k_up"));
        k_up->setGeometry(QRect(150, 30, 69, 27));
        k_up->setDecimals(3);
        k_up->setMaximum(5);
        k_up->setSingleStep(0.1);
        k_up->setValue(0.1);
        frame->raise();
        tabWidget->raise();
        error_model->raise();
        ...
        button_changefolder->setGeometry(QRect(570, 660, 24, 25));
        ...
        memory_option->setCurrentIndex(1);
        memory_option_2->setCurrentIndex(0);
        error_model->setCurrentIndex(0);
        user_bw_up_unit->setCurrentIndex(1);
        user_bw_down_unit->setCurrentIndex(1);
        error_model_2->setCurrentIndex(0);
    ...
    void retranslateUi(QMainWindow *kupagui)
    {
        ...
        tcp_mem_user_rmem->setText(QApplication::translate("kupagui", "4096 87380 8388608", 0));
        ...
        tcp_mem_user->setText(QApplication::translate("kupagui", "4096 87380 8388608", 0));
        ...
        tcp_mem_user_wmem->setText(QApplication::translate("kupagui", "4096 87380 8388608", 0));
        ...
        tcp_mem_server->setText(QApplication::translate("kupagui", "4096 87380 8388608", 0));
#ifndef QT_NO_TOOLTIP
        ...
        tcp_mem_server_rmem->setText(QApplication::translate("kupagui", "4096 87380 8388608", 0));
        ...
        tcp_mem_server_wmem->setText(QApplication::translate("kupagui", "4096 87380 8388608", 0));
        ...
        tcp_mem_user_rmem_wget->setText(QApplication::translate("kupagui", "4096 87380 8388608", 0));
        ...
        tcp_mem_user_wget->setText(QApplication::translate("kupagui", "4096 87380 8388608", 0));
        ...
        tcp_mem_user_wmem_wget->setText(QApplication::translate("kupagui", "4096 87380 8388608", 0));
        ...
        label_9->setText(QApplication::translate("kupagui", "Error Model (down)", 0));
        label_10->setText(QApplication::translate("kupagui", "Error Rate (down)", 0));
        user_bw_up_unit->clear();
        user_bw_up_unit->insertItems(0, QStringList()
         << QApplication::translate("kupagui", "Mbps", 0)
         << QApplication::translate("kupagui", "Gbps", 0)
        );
        user_bw_down_unit->clear();
        user_bw_down_unit->insertItems(0, QStringList()
         << QApplication::translate("kupagui", "Mbps", 0)
         << QApplication::translate("kupagui", "Gbps", 0)
        );
        label_5->setText(QApplication::translate("kupagui", "Down", 0));
        label_6->setText(QApplication::translate("kupagui", "Up", 0));
        label_7->setText(QApplication::translate("kupagui", "Bandwidth", 0));
        label_27->setText(QApplication::translate("kupagui", "Delay (downstream)", 0));
        ...
        error_model_2->clear();
        error_model_2->insertItems(0, QStringList()
         << QApplication::translate("kupagui", "Rate", 0)
         << QApplication::translate("kupagui", "Burst", 0)
        );
        label_2->setText(QApplication::translate("kupagui", "(up)", 0));
        label_3->setText(QApplication::translate("kupagui", "(up)", 0));
        label_38->setText(QApplication::translate("kupagui", "Delay (upstream)", 0));
        label_39->setText(QApplication::translate("kupagui", "PDV (ms)", 0));
        label_40->setText(QApplication::translate("kupagui", "AVG_ DELAY (ms)", 0));
        label_41->setText(QApplication::translate("kupagui", "k", 0));
