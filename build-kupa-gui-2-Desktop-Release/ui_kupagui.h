...
public:
    ...
    void setupUi(QMainWindow *kupagui)
    {
        ...
        groupBox->setGeometry(QRect(10, 0, 481, 321));
        ...
        groupBox_2->setGeometry(QRect(170, 240, 301, 81));
        QPalette palette;
        ...
        label_20->setGeometry(QRect(20, 20, 51, 17));
        label_21 = new QLabel(groupBox_2);
        label_21->setObjectName(QStringLiteral("label_21"));
        label_21->setGeometry(QRect(130, 20, 67, 17));
        label_22 = new QLabel(groupBox_2);
        label_22->setObjectName(QStringLiteral("label_22"));
        label_22->setGeometry(QRect(220, 20, 31, 20));
        alpha_value = new QDoubleSpinBox(groupBox_2);
        alpha_value->setObjectName(QStringLiteral("alpha_value"));
        alpha_value->setGeometry(QRect(20, 40, 69, 27));
        ...
        theta_value->setGeometry(QRect(120, 40, 69, 27));
        ...
        k_value->setGeometry(QRect(220, 40, 69, 27));
        ...
        button_changefolder->setGeometry(QRect(460, 560, 24, 25));
